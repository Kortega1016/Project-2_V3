...
int main() {
	...
	string variable; //To ask if they enjoyed the game or not
	...
	if ( y == 'n' ) {
		...
		cout << "Enter the number of games you'll play: " << endl; 
		cin >> choices;

		for (int i = 0; i < choices; i++) {
			
                        //Players wager
			cout << "Enter how much you want to wager: " << endl;
			cin >> wager;
	...
	myfile2.close();	
        ...
        cout << "Did you have fun? Enter 'yes' or 'no'.";
        cin >> variable;
        if (variable == "yes"){
            bool answer;
            answer = hadFun();
